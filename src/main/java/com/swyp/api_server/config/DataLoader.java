    ...
    private void loadInitialBankData() {
        ...
        List<BankExchangeInfo> initialBanks = Arrays.asList(
            ...
            BankExchangeInfo.builder()
                    .bankName("KB국민은행")
                    .bankCode("004")
                    .spreadRate(BigDecimal.valueOf(1.5))
            ...
            BankExchangeInfo.builder()
                    ...
                    .feeRate(BigDecimal.valueOf(0.08))
                    .minAmount(BigDecimal.valueOf(100))
                    .maxAmount(BigDecimal.valueOf(3000))
                    .isOnlineAvailable(true)
                    .description("하나원큐 70% 우대율 적용")
                    .displayOrder(3)
                    .isActive(true)
                    .build(),
            ...
            BankExchangeInfo.builder()
                    .bankName("SC제일은행")
                    .bankCode("023")
                    .spreadRate(BigDecimal.valueOf(1.6))
                    .preferentialRate(BigDecimal.valueOf(45))
                    .fixedFee(BigDecimal.valueOf(2500))
                    .feeRate(BigDecimal.valueOf(0.12))
                    .minAmount(BigDecimal.valueOf(200))
                    .maxAmount(BigDecimal.valueOf(8000))
                    .isOnlineAvailable(true)
                    .description("SC인터넷뱅킹 45% 우대율")
                    .displayOrder(5)
                    .isActive(true)
                    .build(),
            ...
            BankExchangeInfo.builder()
                    ...
                    .preferentialRate(BigDecimal.valueOf(55))
                    .fixedFee(BigDecimal.valueOf(1800))
                    .feeRate(BigDecimal.valueOf(0.09))
                    .minAmount(BigDecimal.valueOf(300))
                    .maxAmount(BigDecimal.valueOf(6000))
                    .isOnlineAvailable(true)
                    .description("씨티 프리미어 55% 우대율")
                    .displayOrder(6)
                    .isActive(true)
                    .build(),
            ...
            BankExchangeInfo.builder()
                    .bankName("IM뱅크")
                    .bankCode("031")
                    .spreadRate(BigDecimal.valueOf(0.9))
                    .preferentialRate(BigDecimal.valueOf(85))
                    .fixedFee(BigDecimal.valueOf(500))
